...
Project, project Threads, Graveyard, and the global inbox surfaces all preserve
the last good snapshot across transient refresh failures and expose
...
- migrate remaining app project views, starting with plan editing, off
