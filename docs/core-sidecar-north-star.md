...
`desktop-state`, the durable notification feed, Coordination, and Library all
...
- migrate remaining app project views, starting with Topology, Project, and
  global inbox surfaces, off screen-local fetch state
