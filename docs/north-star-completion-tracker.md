...
| 2026-07-06 | TBD | TUI API boundary enforcement | Partial | Done | Raw project-service transport checks moved into `tui-api-runtime`; production TUI source scan now fails if screens bypass the shared API runtime. |
