...
pub fn render_overseer_overlay_output(ctx: &Value, cols: usize, rows: usize) -> String {
    build_overseer_overlay_output(ctx, cols, rows)
}

pub fn render_overseer_watch_instructions_overlay_output(
    ctx: &Value,
    cols: usize,
    rows: usize,
) -> Option<String> {
