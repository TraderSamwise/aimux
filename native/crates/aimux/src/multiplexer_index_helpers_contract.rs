...
pub fn run_multiplexer_index_helpers_contract_case(api: &str, input: &Value) -> Value {
    match api {
        ...
        "MultiplexerMethodSurface" => multiplexer_method_surface(),
...
const DASHBOARD_INTERACTION_METHODS: &[&str] = &[
    "activateDashboardEntry",
    "activateDashboardEntryByNumber",
    "activateDashboardService",
...
const DASHBOARD_VIEW_METHODS: &[&str] = &[
...
const DASHBOARD_ACTION_METHODS: &[&str] = &[
    "activateNextAttentionEntry",
    "attentionScore",
    "buildActiveDashboardOverlayOutput",
    "describeHandoffState",
    "ensureDashboardControlPlane",
    "getFromProjectService",
    "getPreferredThreadIndexForParticipant",
    ...
    "refreshRuntimeGuard",
    "renderActiveDashboardOverlay",
    "renderCoordination",
    "renderOrchestrationInput",
    "renderOrchestrationRoutePicker",
    "renderProject",
    "renderThreadReply",
    "renderToolPicker",
    "renderTopology",
...
const DASHBOARD_TAIL_METHODS: &[&str] = &[
    "basename",
...
const PERSISTENCE_METHODS: &[&str] = &[
    ...
    "writePrecomputedTmuxStatuslineFiles",
    "writeStatuslineFile",
    "writeStatuslineTextFile",
];

const DASHBOARD_STATE_METHODS: &[&str] = &[
    "applyDashboardModel",
    ...
    "getDashboardUiClientKey",
    "getDashboardViewportTarget",
    "getViewportKey",
    "getViewportSize",
    ...
    "restoreDashboardSelectionFromPreference",
...
const RUNTIME_LIFECYCLE_METHODS: &[&str] = &[
    "adjustAfterRemove",
...
const CORE_PROTOTYPE_METHODS: &[&str] = &[
    "activeSession",
    ...
    "dashboardBusyState",
    "dashboardErrorState",
    "deriveSessionSemanticState",
    "ensureProjectServiceEndpoint",
    "focusSession",
    "footerFlash",
    "footerFlashTicks",
    "forkSessionFromSource",
    ...
    "resolveNativeForkLaunch",
    "resolveSessionAlertDisplayContext",
    "restoreSessions",
    "resumeSessions",
    "run",
    "runDashboard",
    "runProjectService",
    "runtimeGuardActiveMs",
    "runtimeGuardState",
    "selectLinkedOrOpenTarget",
    "sessionCount",
...
fn multiplexer_method_surface() -> Value {
    json!({
        "result": {
            "delegatedGroups": {
                "dashboardInteractionMethods": DASHBOARD_INTERACTION_METHODS,
                "dashboardViewMethods": DASHBOARD_VIEW_METHODS,
                "dashboardActionMethods": DASHBOARD_ACTION_METHODS,
                "dashboardTailMethods": DASHBOARD_TAIL_METHODS,
                "persistenceMethods": PERSISTENCE_METHODS,
                "dashboardStateMethods": DASHBOARD_STATE_METHODS,
                "agentIoMethods": AGENT_IO_METHODS,
                "runtimeLifecycleMethods": RUNTIME_LIFECYCLE_METHODS,
            },
            "delegatedMethodCount": 273,
            "missingDelegatedMethods": [],
            "nonFunctionDelegatedMethods": [],
            "corePrototypeMethods": CORE_PROTOTYPE_METHODS,
        },
        "calls": [],
    })
}
