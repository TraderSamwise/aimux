...
pub use tasks::{parse_core_task_args, parse_core_task_args_result};
pub use threads::{parse_core_thread_args, parse_core_thread_args_result};
pub use workflow::{
...
pub fn is_core_cli_command<S: AsRef<str>>(args: &[S]) -> bool {
    ...
    match (command, subcommand) {
        ...
        (Some("message"), Some("send")) => true,
        (Some("handoff"), Some("send" | "accept" | "complete")) => true,
