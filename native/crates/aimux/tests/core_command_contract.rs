...
fn core_api_routes_match_the_typescript_contract() {
    let expected = [
        ...
        ("doctorCoherenceText", "/core/doctor/coherence-text"),
        ...
        ("jobsCallbacksKick", "/jobs/callbacks/kick"),
        ...
        ("loopPauseText", "/core/loop/pause-text"),
        ("loopRemoveText", "/core/loop/remove-text"),
        ("loopUnpauseText", "/core/loop/unpause-text"),
        ...
        ("outlineListText", "/core/outline/list-text"),
...
fn constant_objects_serialize_with_typescript_keys() {
    ...
    assert_eq!(routes["doctorCoherenceText"], "/core/doctor/coherence-text");
    ...
    assert_eq!(routes["doctorStabilityText"], "/core/doctor/stability-text");
    assert_eq!(
