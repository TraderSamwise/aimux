...
fn run_shell_hooks_contract_case(input: &Value) -> Value {
...
fn summarize_prepared(prepared: &PreparedShellIntegration) -> Value {
...
fn generated_files(prepared: &PreparedShellIntegration) -> Value {
