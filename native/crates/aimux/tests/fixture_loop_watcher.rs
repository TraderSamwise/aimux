#[path = "../src/loop_watcher_contract.rs"]
mod loop_watcher_contract;

use loop_watcher_contract::run_loop_watcher_contract_case;
...
fn loop_watcher_contract_matches_typescript() {
    ...
    for case in contract.cases {
        let actual = run_loop_watcher_contract_case(&case.input);
