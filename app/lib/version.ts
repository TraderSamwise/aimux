...
export const APP_VERSION = {
  ...
  buildNumber: 1, // Native build number (increments only for native builds)
  otaVersion: 0, // OTA update version (increments for JS updates)
  timestamp: "2026-05-19T00:00:00Z", // Last update timestamp
  channel: "development", // 'testflight' for TestFlight or 'production' for App Store
};
