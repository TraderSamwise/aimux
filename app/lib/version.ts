...
export const APP_VERSION = {
  ...
  buildNumber: 19, // Native build number (increments only for native builds)
  otaVersion: 11, // OTA update version (increments for JS updates)
  timestamp: "2026-08-16T03:14:58Z", // Last update timestamp
