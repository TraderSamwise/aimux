...
export const APP_VERSION = {
  ...
  buildNumber: 22, // Native build number (increments only for native builds)
  otaVersion: 14, // OTA update version (increments for JS updates)
  timestamp: "2026-08-18T04:43:27Z", // Last update timestamp
