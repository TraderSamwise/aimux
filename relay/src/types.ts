...
export interface Env {
  ...
  // warn: record device proof metadata when clients support signing.
  // enforce: deny owner client connections without a valid device proof.
  SECURITY_DEVICE_PROOF_POLICY?: "warn" | "enforce";
