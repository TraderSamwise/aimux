...
Summary: 274 suites, 321 suite/corpus bindings, 3917 cases.
...
| `fixture_multiplexer_runtime_state_methods` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/runtime-state-methods.json` | 49 | mutated fixture output failed owning Rust suite |
