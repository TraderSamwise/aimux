...
Summary: 274 suites, 321 suite/corpus bindings, 3899 cases.
...
| `fixture_multiplexer_runtime_state_refresh` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/runtime-state-refresh.json` | 10 | mutated fixture output failed owning Rust suite |
