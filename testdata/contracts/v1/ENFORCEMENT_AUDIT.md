...
Summary: 226 suites, 272 suite/corpus bindings, 3471 cases.
...
| `fixture_multiplexer_persistence_worktrees` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/persistence-worktrees.json` | 13 | mutated fixture output failed owning Rust suite |
...
| `fixture_multiplexer_runtime_state_methods` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/runtime-state-methods.json` | 21 | mutated fixture output failed owning Rust suite |
...
| `fixture_multiplexer_services_runtime` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/services-runtime.json` | 11 | mutated fixture output failed owning Rust suite |
| `fixture_multiplexer_worktrees` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/worktrees.json` | 16 | mutated fixture output failed owning Rust suite |
...
| `fixture_tool_picker` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/tool-picker.json` | 12 | mutated fixture output failed owning Rust suite |
