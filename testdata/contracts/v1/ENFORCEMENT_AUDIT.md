...
Summary: 233 suites, 280 suite/corpus bindings, 3550 cases.
Binding statuses: PROVEN-FAILS 280, VACUOUS 0, CHECKLIST 0, ERROR 0, STATIC 0.
...
| `fixture_multiplexer_worktrees_settlement` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/worktrees-settlement.json` | 15 | mutated fixture output failed owning Rust suite |
