...
Summary: 274 suites, 321 suite/corpus bindings, 3912 cases.
...
| `fixture_multiplexer_runtime_state_methods` | PROVEN-FAILS | `testdata/contracts/v1/multiplexer/runtime-state-methods.json` | 44 | mutated fixture output failed owning Rust suite |
