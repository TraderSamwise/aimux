...
Under that definition there are 245 `src` test modules, 156 covered modules, and
89 uncovered modules remaining. The older 196-uncovered baseline is stale; from
that baseline, 107 modules have been covered.
