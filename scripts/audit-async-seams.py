...
ALLOWED_SEAMS = [
    ...
    AllowedSeam(
        ...
        1,
        "transitional",
        "sync subprocess wrapper retained until all Command callers convert",
    ),
    AllowedSeam(
        "native/crates/aimux/src/async_subprocess.rs",
    ...
    AllowedSeam(
        "native/crates/aimux/src/daemon/listener.rs",
        "async_runtime::block_on_named(",
        1,
        "transitional",
        "sync daemon listener entry retained while daemon route families convert",
    ),
    AllowedSeam(
    ...
    AllowedSeam(
        ...
        1,
        "transitional",
        "temporary spawn route seam owned by the destructive lifecycle conversion",
    ),
    AllowedSeam(
