...
ALLOWED_SEAMS = [
    ...
    AllowedSeam(
        ...
        1,
        "transitional",
        "bounded output bridge for remaining sync CLI, TUI, debug, git-root, and process-inspection callers",
    ),
    AllowedSeam(
        "native/crates/aimux/src/async_subprocess.rs",
        ...
        1,
        "transitional",
        "bounded status bridge for remaining sync CLI, readiness, hyperlink, cleanup, and runtime-adapter callers",
    ),
    AllowedSeam(
        "native/crates/aimux/src/async_subprocess.rs",
        ...
        1,
        "transitional",
        "detached launch bridge for remaining sync long-lived process launchers; helper disables kill_on_drop",
    ),
    AllowedSeam(
        "native/crates/aimux/src/async_subprocess.rs",
        ".block_on(handle)",
